...
################################################################
# This is a generated script based on design: mux2x1_1
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net notgate_0_y [get_bd_pins andgate_0/b] [get_bd_pins notgate_0/y]
  connect_bd_net -net orgate_0_c [get_bd_ports f] [get_bd_pins orgate_0/c]
  connect_bd_net -net s_1 [get_bd_ports s] [get_bd_pins andgate_1/a] [get_bd_pins notgate_0/a]
